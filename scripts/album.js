 ...
 var setCurrentAlbum = function (album) {
     ...
     // #4 
     // loop through all the songs from the specified album object
     // createSong function is called at each loop 
 ...
 // Assignment
 // Add an event listener to the album cover. When a user clicks it, 
 // the album page content should toggle between the three album objects: 
 // albumPicasso, albumMarconi, and your album object.
 // use an array, think about their indexes 

 window.onload = function () {
     setCurrentAlbum(albumPicasso);

     var albumLoop = [albumPicasso, albumMarconi, albumStrangerThings];
     var position = 1;
     document.getElementsByClassName('album-cover-art')[0].addEventListener('click', function () {
         setCurrentAlbum(albumLoop[position]);
         position++;
         if (position == 3) {
             position = 0;
         }
